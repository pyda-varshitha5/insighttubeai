...
>       <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-violet-100">
  ...
  onClick={() => {
    ...
    router.push(
      `/quizzes?topic=${encodeURIComponent(topic)}`
    );
  }}
  className="group flex items-center gap-3 rounded-2xl border border-emerald-200 bg-white px-5 py-4 shadow-sm transition hover:border-emerald-400 hover:shadow-md"
>
